 ...
 */
@Entity
@Table(name = "trabajador", catalog = "bd", schema = "")
@XmlRootElement
@NamedQueries({
...
public class Trabajador implements Serializable {
    ...
    public Trabajador(Integer id, String nombre, String email, String cargo, String direccion) {
        this.id = id;
        this.nombre = nombre;
        this.email = email;
        this.cargo = cargo;
    ...
    public String toString() {
        return "com.personal.modelos.Trabajador[ id=" + id + " ]";
    }
